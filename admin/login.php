...
$sql = "SELECT email AND password FROM admin WHERE email = '".$email."' AND password = '".$password."' LIMIT 1";
...
<div class="container" style="padding-top: 220px; padding-bottom: 200px;">
 ...
 <form method="post" class="shadow-lg p-4" action="#">
      ...
      <input type="password" class="form-control" name="password" placeholder="Enter Your Password">
       ...
       <a href ="../admin/register.php" class="btn btn-outline-secondary mt-3 font-weight-bold btn-block shadow-sm">Register here</a>

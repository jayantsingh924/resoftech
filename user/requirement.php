...
include('../headers/connection.php'); 
  ...
  if (isset($_REQUEST['submit'])) 
    ...
    $sql = "INSERT INTO requirement(subject, summary, file_desc) VALUES('$subject','$summary','$info')";
            
            if ($conn->query($sql) == TRUE) 
                  {
                    $result = '<div class="alert alert-success mt-2" roll="alert">
                    <font color="Green"><h3>Requirement Created Sucessfully.</h3></font></div>';
                ...
                else
                  {
                    ...
                    <font color="Green"><h3>Unable to Submit your Request.</h3></font></div>';
                  }

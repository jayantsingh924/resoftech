...
<?php 
            ...
            define('PAGE', 'dicussion');
            define('TITLE', 'Dicussion');
            define('MENU', 'menu');
            define('TABLE', 'dicussion');
...
include('../headers/connection.php'); 
  ...
  if (isset($_REQUEST['submit'])) 
    ...
    $sql = "INSERT INTO dicussion(subject, summary, file_desc) VALUES('$subject','$summary','$info')";
           if ($conn->query($sql) == TRUE) 
                  {
                    $result = '<div class="alert alert-success mt-2" roll="alert">
                    <font color="Green"><h3>Dicussion Created Sucessfully.</h3></font></div>';
                    $genid = mysqlI_insert_id($conn); 
               
                    $_SESSION['id'] = $genid;
                    $_SESSION['table'] = 'dicussion';
                ...
                else
                  {
                    ...
                    <font color="red"><h3>Unable to Submit your Dicussion.</h3></font></div>';
                  }

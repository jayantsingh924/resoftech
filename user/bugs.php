...
include('../headers/connection.php'); 
  ...
  if (isset($_REQUEST['submit'])) 
    ...
    $sql = "INSERT INTO bugs(subject, summary, file_desc) VALUES('$subject','$summary','$info')";
            
            if ($conn->query($sql) == TRUE) 
                  {
                    $result = '<div class="alert alert-success mt-2" roll="alert">
                    <font color="Green"><h3>Bug Created Sucessfully.</h3></font></div>';
                ...
                else
                  {
                    ...
                    <font color="Green"><h3>Unable to Submit your Bug.</h3></font></div>';
                  }

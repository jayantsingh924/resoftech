...
<?php 
            ...
            define('PAGE', 'Daily Updates');
            define('TITLE', 'Daily Updates');
            define('MENU', 'menu');
            include('nav.php'); 
...
include('../headers/connection.php'); 
  ...
  if (isset($_REQUEST['submit'])) 
    ...
    $sql = "INSERT INTO dailyupdate(subject, summary, file_desc) VALUES('$subject','$summary','$info')";
            
            if ($conn->query($sql) == TRUE) 
                  {
                    $result = '<div class="alert alert-success mt-2" roll="alert">
                    <font color="Green"><h3>Daily Update Created Sucessfully.</h3></font></div>';
                    $genid = mysqlI_insert_id($conn); 
               
                    $_SESSION['id'] = $genid;
                    $_SESSION['table'] = 'dailyupdate';
                ...
                else
                  {
                    ...
                    <font color="Green"><h3>Unable to Submit your Update.</h3></font></div>';
                  }
